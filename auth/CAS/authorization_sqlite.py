...
from auth.CAS.models.db_sqlite import make_db_connection, AuthGroup, AuthMembership, AuthPermission
...
class Authorization(object):
    ...
    def get_permissions(self, role):
        ...
        permissions = self.permission_model.get_all_by_group(self.client, target_role['id'])
    ...
    def get_user_permissions(self, user):
        ...
        results = []
        for group in groups:
            permissions = self.permission_model.get_all_by_group(self.client, group['id'])
